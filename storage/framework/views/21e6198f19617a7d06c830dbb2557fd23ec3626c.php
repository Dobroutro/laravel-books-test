...
<div class='col-lg-4 col-lg-offset-4'>
    ...
    <?php echo e(Form::model($item, ['role' => 'form', 'url' => '/books/' . $item->id, 'files' => 'true' , 'method' => 'PUT'])); ?>
        ...
        <select name="author_id" class="form-control">
            <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <option value="<?php echo e($author->id); ?>" 
                    <?php if($author->id == $item->author_id): ?> selected="selected" <?php endif; ?>>
    ...
    <?php if($item->imagename): ?>
        <div class='form-group'>
            <?php echo e(Html::image('images/books/'.$item->imagename, 'picture', array('class' => 'thumb'))); ?>        
        </div>
    <?php endif; ?>     
